...
namespace JeffersonGoncalves\FilamentCommerce\Payment\Tests;

use Filament\Facades\Filament;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Illuminate\Support\Facades\Schema;
use JeffersonGoncalves\Commerce\Payment\CommercePaymentServiceProvider;
use JeffersonGoncalves\FilamentCommerce\Core\Testing\CommerceFilamentTestCase;
use JeffersonGoncalves\FilamentCommerce\Payment\FilamentCommercePaymentServiceProvider;
use JeffersonGoncalves\FilamentCommerce\Payment\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentCommerce\Payment\Tests\Fixtures\TestUser;
...
abstract class TestCase extends CommerceFilamentTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentCommercePaymentServiceProvider::class,
